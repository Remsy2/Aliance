...
<div class="modal" id="alert-modal">
  <div class="modal-dialog">
    ...
    <a href="#" class="modal-close" data-toggle="modal" data-target="#alert-modal" aria-label="Закрыть окно">
...
<div class="modal">
  <div class="modal-dialog">
    ...
    <a href="#" class="modal-close" data-toggle="modal" data-target="#feedback-modal" aria-label="Закрыть окно">
      <svg class="close-icon" width="24" height="24">
        <use href="img/sprite.svg#close"></use>
      </svg>
    </a>
